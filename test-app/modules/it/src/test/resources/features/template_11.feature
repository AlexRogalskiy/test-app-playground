...
Feature: Testing a REST API with page template-11 (loop-dependency)
  ...
  Scenario: Page template (template_11) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_11.yaml'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_11.json' should be successfully returned
