...
Feature: Testing a REST API with page template-5 (invalid file format)
  ...
  Scenario: Page template (template_5) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_5.pdf'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_5.json' should be successfully returned
