...
Feature: Testing a REST API with page template-2 (invalid parent id dependency)
  ...
  Scenario: Page template (template_2) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_2.yaml'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_2.json' should be successfully returned
