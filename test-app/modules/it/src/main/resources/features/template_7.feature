...
Feature: Testing a REST API with page template-7 (invalid template format)
  ...
  Scenario: Page template (template_7) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_7.yaml'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_7.json' should be successfully returned
