...
Feature: Testing a REST API with page template-3 (invalid parent id dependency)
  ...
  Scenario: Page template (template_3) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_3.yml'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_3.json' should be successfully returned
