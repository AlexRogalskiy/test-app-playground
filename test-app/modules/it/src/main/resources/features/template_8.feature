...
Feature: Testing a REST API with page template-8 (empty file extension)
  ...
  Scenario: Page template (template_8) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_8'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_8.json' should be successfully returned
