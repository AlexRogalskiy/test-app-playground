...
Feature: Testing a REST API with page template-4
  ...
  Scenario: Page template (template_4) uploaded to a web service
    ...
    And users provide page template file 'src/test/resources/templates/request/template_4.yaml'
  ...
  Scenario: Page templates retrieved from a web service
    ...
    Then page templates data 'src/test/resources/templates/response/template_4.json' should be successfully returned
