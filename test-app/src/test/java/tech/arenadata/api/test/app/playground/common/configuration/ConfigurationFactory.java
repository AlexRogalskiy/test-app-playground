...
import tech.arenadata.api.test.app.playground.common.utils.ServiceUtils;

import java.time.Duration;

import static tech.arenadata.api.test.app.playground.common.enumeration.ConfigPropertyType.*;
import static tech.arenadata.api.test.app.playground.common.exception.ConfigurationException.*;
import static tech.arenadata.api.test.app.playground.common.utils.ConfigurationUtils.getProperty;
import static tech.arenadata.api.test.app.playground.common.utils.ServiceUtils.*;
...
public final class ConfigurationFactory {
	 ...
	 */
	private static final Duration DEFAULT_CONNECT_TIMEOUT = Duration.ofMillis(5_000);
	private static final Duration DEFAULT_CONNECTION_REQUEST_TIMEOUT = Duration.ofMillis(5_000);
	private static final Duration DEFAULT_SOCKET_TIMEOUT = Duration.ofMillis(5_000);
