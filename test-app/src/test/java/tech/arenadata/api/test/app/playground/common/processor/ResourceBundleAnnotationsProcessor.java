package tech.arenadata.api.test.app.playground.common.processor;

import com.google.errorprone.annotations.FormatMethod;
import com.google.errorprone.annotations.FormatString;
import org.apache.commons.lang3.StringUtils;
import tech.arenadata.api.test.app.playground.common.annotation.GenerateResourceBundle;
...
@SupportedAnnotationTypes(
	"tech.arenadata.api.test.app.playground.common.annotation.GenerateResourceBundle")
...
public class ResourceBundleAnnotationsProcessor extends AbstractProcessor {
	...
	public static final String BUNDLES_FILE = "test-app-playground.bundle.json";
	...
	private void generateFile(final List<String> elements) {
		try {
			...
			this.printError("Could not create/write '{%s}' file: {%s}", e.toString(), ResourceBundleAnnotationsProcessor.BUNDLES_FILE);
		}
	}
}
